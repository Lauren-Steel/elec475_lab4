...
def train_model(data_path, batch_size, num_epochs, learning_rate, alpha, beta, tau, num_classes=21, device='cpu'):
    ...
    save_path = '/content/drive/MyDrive/ColabNotebooks/lab4/results/model/distil_model.pth'
    torch.save(student_model.state_dict(), save_path)
    print(f"Student model saved to: {save_path}")

    plot_path = '/content/drive/MyDrive/ColabNotebooks/lab4/results/plots/distil_loss_plot.png'
...
def main():
    ...
    parser.add_argument('--alpha', type=float, default=0.5, help='Weight for cross-entropy loss')
    parser.add_argument('--beta', type=float, default=0.5, help='Weight for distillation loss')
